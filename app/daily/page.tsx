	...
	return (
		<div className="max-w-2xl mx-auto pt-10">
			...
			<div className="bg-gray-900 rounded-xl p-8">
				...
				<input type="text" placeholder="Describe the image..." className="w-full mt-6 p-4 rounded-lg text-lg" />
				<button className="mt-4 bg-purple-600 hover:bg-purple-700 text-white font-bold py-4 px-8 rounded-lg text-xl">
					Submit Guess
				</button>
			</div>
		</div>
